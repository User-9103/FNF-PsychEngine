...
To install LuaJIT do this: `haxelib git linc_luajit https://github.com/Sirox228/linc_luajit.git` on a Command prompt/PowerShell
...
1. Download
* [JDK](https://www.oracle.com/java/technologies/downloads/#java18) - Download version `19` of it
...
To install `extension-androidtools` run this: `haxelib git extension-androidtools https://github.com/MAJigsaw77/extension-androidtools.git` on a CMD/PowerShell window
...
If you want video support on your mod, simply do `haxelib git hxCodec https://github.com/AlvarroPewz24/hxCodec` on a Command prompt/PowerShell
...
### Android Support
* M.A. Jigsaw - All the things needed for this engine to support android
_____________________________________
